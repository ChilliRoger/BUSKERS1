                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    <div className="glass-card p-6 text-center hover-glow">
                      <div className="text-2xl font-bold text-indigo-400 mb-2 font-poppins">Kadena</div>
                      <div className="text-gray-300 font-inter mb-3">Blockchain Infrastructure</div>
                      <div className="text-xs text-indigo-300 font-inter">Secure & Scalable</div>
                    </div>
                    <div className="glass-card p-6 text-center hover-glow-mint">
                      <div className="text-2xl font-bold text-mint-400 mb-2 font-poppins">PayPal</div>
                      <div className="text-gray-300 font-inter mb-3">PYUSD Payments</div>
                      <div className="text-xs text-mint-300 font-inter">Stable & Reliable</div>
                    </div>
                    <div className="glass-card p-6 text-center hover-glow-coral">
                      <div className="text-2xl font-bold text-coral-400 mb-2 font-poppins">Walrus</div>
                      <div className="text-gray-300 font-inter mb-3">Decentralized Storage</div>
                      <div className="text-xs text-coral-300 font-inter">Immutable & Fast</div>
                    </div>
                  </div>
                </motion.div>
          </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <Link
                href="/events"
                className="glass-card p-6 shadow-lg hover:shadow-xl transition-all duration-300 text-center group block hover-glow"
              >
            ...
            >
              <Link
                href="/posts"
                className="glass-card p-6 shadow-lg hover:shadow-xl transition-all duration-300 text-center group block hover-glow-mint"
              >
            ...
            >
              <Link
                href="/profile"
                className="glass-card p-6 shadow-lg hover:shadow-xl transition-all duration-300 text-center group block hover-glow-coral"
              >
