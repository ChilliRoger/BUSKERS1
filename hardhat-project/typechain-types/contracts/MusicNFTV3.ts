...
export interface MusicNFTV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MusicNFTV3 extends BaseContract {
  connect(runner?: ContractRunner | null): MusicNFTV3;
  waitForDeployment(): Promise<this>;

  interface: MusicNFTV3Interface;
