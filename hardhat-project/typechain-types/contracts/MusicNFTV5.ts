...
export interface MusicNFTV5Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MusicNFTV5 extends BaseContract {
  connect(runner?: ContractRunner | null): MusicNFTV5;
  waitForDeployment(): Promise<this>;

  interface: MusicNFTV5Interface;
  ...
  pyusdAddress: TypedContractMethod<[], [string], "view">;
