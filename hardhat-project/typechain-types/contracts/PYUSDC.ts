...
export interface PYUSDCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "airdrop"
      | "allowance"
...
export interface PYUSDC extends BaseContract {
  connect(runner?: ContractRunner | null): PYUSDC;
  waitForDeployment(): Promise<this>;

  interface: PYUSDCInterface;
